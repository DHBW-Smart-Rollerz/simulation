...
from simulation.groundtruth.geometry import Line, Point, Transform, Vector
from simulation.groundtruth.road.config import Config
from simulation.groundtruth.road.sections.intersection import Intersection
...
class ModuleTest(unittest.TestCase):
    ...
    def test_intersection(self):
        ...
        middle_line_vt = TF * Line(
            [Point(SIZE / 2, SIZE / 2), Point(SIZE / 2, -SIZE / 2)]
        )
        ...
        middle_line_vt_tf = self.rotate_around_point(
            middle_line_vt, angle, inter_mid_point
        )
        right_line_vt_tf = self.rotate_around_point(
            right_line_vt, angle, inter_mid_point
        )
